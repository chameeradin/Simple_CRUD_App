...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h2 class="justify-content-center">{{__('Update Post')}}</h2>
            @if (session('status'))
                <div class="card">
                    <div class="card-body">
                    ...
                    <form action="{{route('posts.update', $post->id)}}" enctype="multipart/form-data" method="post">
                        ...
                        <div class="form-row">
                            <div class="form-group mb-4">
                                ...
                                <input type="text" value="{{old('title')}}" name="title" class="form-control form-control-sm  @error('title') is-invalid @enderror" id="title" placeholder="{{$post->title}}">
                                @error('title')
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea name="description" class="form-control form-control-sm @error('description') is-invalid @enderror" aria-label="description" placeholder="{{$post->description}}">{{old('description')}}</textarea>
                                @error('description')
                                <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group">
                                <img src="/storage/{{ $post->image }}" width="300px">
                            </div>
